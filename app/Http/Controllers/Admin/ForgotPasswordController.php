...
class ForgotPasswordController extends Controller
{
    ...
    public function showResetPasswordFormApp($token) { 
        return view('admin.auth.forgetPasswordLinkApp', ['token' => $token]);
    }

    public function submitResetPasswordFormApp(Request $request)
    {
        $request->validate([
            'email' => 'required|email|exists:users',
            'password' => 'required|string|min:6|confirmed',
