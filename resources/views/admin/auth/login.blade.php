                        ...
                        <div class="form-side">
                            ...
                            <form method="POST" action="{{ route('login.custom') }}">
                                ...
                                <label class="form-group has-float-label mb-4">
                                    <input class="form-control" type="text" value="{{ old('e_mail') }}" name="e_mail" id="e_mail" autofocus/>
                                    <span>E-mail</span>
                                </label>
                                ...
                                <div class="justify-content-between align-items-center mb-1">
                                    ...
                                    <div class="alert alert-danger"><strong>The email field is required.</strong>
                                        </div>
                                    @endif
